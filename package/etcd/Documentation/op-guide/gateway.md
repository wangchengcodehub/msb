...
2016-08-16 11:21:18.867350 I | tcpproxy: ready to proxy etcd requests to [...]
```

Alternatively, if using DNS for service discovery, consider the DNS SRV entries:

```bash
$ dig +noall +answer SRV _etcd-etcd._tcp.example.com
_etcd-etcd._tcp.example.com. 300 IN SRV 0 0 2379 infra0.example.com.
_etcd-etcd._tcp.example.com. 300 IN SRV 0 0 2379 infra1.example.com.
_etcd-etcd._tcp.example.com. 300 IN SRV 0 0 2379 infra2.example.com.
```
